...
這是一個專為麻醉科部門設計的護理班表管理系統，旨在簡化護理長排班和護理師查詢班表的流程。系統支援麻醉科、恢復室等專科護理師的特殊排班需求，提供直覺化的界面和高效的排班工具。**版本 0.9.0 主要強化了Passkey設備綁定限制機制，實現了一台設備只能綁定一個帳號的安全限制，並修正了相關登入和註冊邏輯。**
